...
traverses only layer-2 switches (IP routing is involved), the VPLS can be oranized 
with the help of 802.1Q protocol. Broadly, speaking this is not a protocol as such, but rather 
