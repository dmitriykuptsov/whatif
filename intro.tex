...
$12.1x$ faster than pure Python implmentation. On the other hand, Python implemenation with bindings
to C library demonstrated performance which was $2.3x$ faster.
