...
IPSec~\cite{tcpip} comes in two variations: Authentication Header and Encapsulating Security Payload (ESP).
...
protocols, such as Internet Key Exchange, can be used to create secure tunnels between the sites.
