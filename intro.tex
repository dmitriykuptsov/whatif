...
traffic to be sniffed and analyzed. In L3-VPN networks, on the otherhand, the networks form different 
...
Virtual Private LAN Services (VPLS) are pretty common nowdays. In this section we will cover 
...
traverses only layer-2 switches (\ie no IP routing is involved), the VPLS can be oranized 
...
Alos, QinQ does not provide additional mechanisms to secure the customer's traffic,
...
The major draback of QinQ and MPLS and QinQ is that they do not offer encryption and 
